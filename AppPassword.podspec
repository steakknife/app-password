Pod::Spec.new do |s|
  s.name     = 'AppPassword'
  s.version  = '0.0.0-dev'
  s.summary  = 'iMAS - Application Password'
  s.description = %[
  ...
  s.source   = { :git => 'https://github.com/project-imas/app-password.git' } 
  s.source_files = 'AppPassword/{APComplexPass,APKeyboardCell,APPass,APQuestionPass,APSimplePass,APSimplePassCell,APViewController}.{h,m}',
  'AppPassword/{AppPassword,APPassProtocol,APProtocol,APQuestionProtocol}.h'
  s.framework = 'Security', 'QuartzCore'
  s.requires_arc = true
  s.dependency 'SecureFoundation', '0.0.0-dev'
end
